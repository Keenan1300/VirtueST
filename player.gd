...
@onready var currentmode = modes.Roaming
...
func _physics_process(delta):
	...
	$AnimationTree.set("parameters/conditions/think",input_dir == Vector2.ZERO && is_on_floor())
	$AnimationTree.set("parameters/conditions/talk",input_dir == Vector2.ZERO && is_on_floor())
	$AnimationTree.set("parameters/conditions/strict",input_dir == Vector2.ZERO && is_on_floor())
	$AnimationTree.set("parameters/conditions/grab",input_dir == Vector2.ZERO && is_on_floor())
